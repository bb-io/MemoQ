...
public class TermBaseActions : BaseInvocable
{
    ...
    private readonly Dictionary<string, string> _csvFileLanguages = new()
    {
        ...
        ["aka"] = "Akan",
        ["alb"] = "Albanian",
        ["alb-AL"] = "Albanian_Albania",
        ["alb-XK"] = "Albanian_Kosovo",
        ["alb-MK"] = "Albanian_Macedonia",
        ["alb-ME"] = "Albanian_Montenegro",
        ["amh"] = "Amharic",
        ["ara"] = "Arabic",
        ["ara-DZ"] = "Arabic_Algeria",
        ["ara-BH"] = "Arabic_Bahrain",
        ["ara-EG"] = "Arabic_Egypt",
        ["ara-IQ"] = "Arabic_Iraq",
        ["ara-JO"] = "Arabic_Jordan",
        ["ara-KW"] = "Arabic_Kuwait",
        ["ara-LB"] = "Arabic_Lebanon",
        ["ara-LY"] = "Arabic_Libya",
        ["ara-MA"] = "Arabic_Morocco",
        ["ara-OM"] = "Arabic_Oman",
        ["ara-QA"] = "Arabic_Qatar",
        ["ara-SA"] = "Arabic_Saudi_Arabia",
        ["ara-SY"] = "Arabic_Syria",
        ["ara-TN"] = "Arabic_Tunisia",
        ["ara-AE"] = "Arabic_U.A.E.",
        ["ara-YE"] = "Arabic_Yemen",
        ["arg"] = "Aragonese",
        ["ocs"] = "Aranese",
        ...
        ["bel"] = "Belarussian",
        ["ben"] = "Bengali",
        ["ben-BD"] = "Bengali_Bangladesh",
        ["ben-IN"] = "Bengali_India",
        ["bis"] = "Bislama",
        ["boc"] = "Bosnian_Cyrillic",
        ["bos"] = "Bosnian_Latin",
        ["bre"] = "Breton",
        ["bul"] = "Bulgarian",
        ["mya"] = "Burmese",
        ...
        ["chr"] = "Cherokee",
        ["ctd"] = "Chin",
        ["zho-HK"] = "Chinese_Hong_Kong_S.A.R.",
        ["zho-MO"] = "Chinese_Macao_S.A.R.",
        ["zho-CN"] = "Chinese_PRC",
        ["zho-SG"] = "Chinese_Singapore",
        ["zho-TW"] = "Chinese_Taiwan",
        ["cho"] = "Choctaw",
        ["chk"] = "Chuukese",
        ["hrv"] = "Croatian",
        ["cze"] = "Czech",
        ...
        ["din"] = "Dinka",
        ["dut"] = "Dutch",
        ["dut-BE"] = "Dutch_Belgium",
        ["dut-NL"] = "Dutch_Netherlands",
        ["eng"] = "English",
        ["eng-AU"] = "English_Australia",
        ["eng-BZ"] = "English_Belize",
        ["eng-CA"] = "English_Canada",
        ["eng-CB"] = "English_Caribbean",
        ["eng-IE"] = "English_Ireland",
        ["eng-JM"] = "English_Jamaica",
        ["eng-NZ"] = "English_New_Zealand",
        ["eng-PH"] = "English_Republic_of_the_Philippines",
        ["eng-ZA"] = "English_South_Africa",
        ["eng-TT"] = "English_Trinidad_and_Tobago",
        ["eng-GB"] = "English_United_Kingdom",
        ["eng-US"] = "English_United_States",
        ["eng-ZW"] = "English_Zimbabwe",
        ["epo"] = "Esperanto",
        ["est"] = "Estonian",
        ["fat"] = "Fanti",
        ["fas"] = "Farsi",
        ...
        ["vls"] = "Flemish",
        ["fre"] = "French",
        ["fre-02"] = "French_Africa",
        ["fre-BE"] = "French_Belgium",
        ["fre-CA"] = "French_Canada",
        ["fre-FR"] = "French_France",
        ["fre-LU"] = "French_Luxembourg",
        ["fre-MC"] = "French_Monaco",
        ["fre-MA"] = "French_Morocco",
        ["fre-CH"] = "French_Switzerland",
        ["fry"] = "Frisian,_Western",
        ["ful"] = "Fulah",
        ["gla"] = "Gaelic_Scotland",
        ["glg"] = "Galician",
        ["kat"] = "Georgian",
        ["ger"] = "German",
        ["ger-AT"] = "German_Austria",
        ["ger-DE"] = "German_Germany",
        ["ger-LI"] = "German_Liechtenstein",
        ["ger-LU"] = "German_Luxembourg",
        ["ger-CH"] = "German_Switzerland",
        ["gre"] = "Greek",
        ["kal"] = "Greenlandic",
        ["grn"] = "Guaraní",
        ["guj"] = "Gujarati",
        ...
        ["gle"] = "Irish",
        ["ita"] = "Italian",
        ["ita-IT"] = "Italian_Italy",
        ["ita-CH"] = "Italian_Switzerland",
        ["jpn"] = "Japanese",
        ["jav"] = "Javanese",
        ["kea"] = "Kabuverdianu",
        ["kan"] = "Kannada",
        ...
        ["mol"] = "Moldavian",
        ["mnw"] = "Mon",
        ["khk"] = "Mongolian_Cyrillic",
        ["cgy"] = "Montenegrin_Cyrillic",
        ["cgl"] = "Montenegrin_Latin",
        ["nau"] = "Nauruan",
        ["nav"] = "Navajo",
        ["nep"] = "Nepali",
        ["nor"] = "Norwegian",
        ["nnb"] = "Norwegian_Bokmål",
        ["nno"] = "Norwegian_Nynorsk",
        ["oci"] = "Occitan",
        ["ori"] = "Oriya",
        ["orm"] = "Oromo",
        ["pbu"] = "Pashto",
        ["pdc"] = "Pennsylvania_German",
        ["pis"] = "Pijin",
        ["pon"] = "Pohnpeian",
        ["pol"] = "Polish",
        ["por"] = "Portuguese",
        ["por-BR"] = "Portuguese_Brazil",
        ["por-PT"] = "Portuguese_Portugal",
        ["pan"] = "Punjabi_Gurmukhi",
        ["pnb"] = "Punjabi_Shahmukhi",
        ["quz"] = "Quechua",
        ["rki"] = "Rakhine",
        ["rhg"] = "Rohingya",
        ["rum"] = "Romanian",
        ...
        ["slv"] = "Slovenian",
        ["som"] = "Somali",
        ["som-DJ"] = "Somali_Djibouti",
        ["som-ET"] = "Somali_Ethiopia",
        ["som-KE"] = "Somali_Kenya",
        ["som-SO"] = "Somali_Somalia",
        ["spa"] = "Spanish",
        ["spa-AR"] = "Spanish_Argentina",
        ["spa-BO"] = "Spanish_Bolivia",
        ["spa-CL"] = "Spanish_Chile",
        ["spa-CO"] = "Spanish_Colombia",
        ["spa-CR"] = "Spanish_Costa_Rica",
        ["spa-DO"] = "Spanish_Dominican_Republic",
        ["spa-EC"] = "Spanish_Ecuador",
        ["spa-SV"] = "Spanish_El_Salvador",
        ["spa-GT"] = "Spanish_Guatemala",
        ["spa-HN"] = "Spanish_Honduras",
        ["spa-M9"] = "Spanish_Latin_America",
        ["spa-MX"] = "Spanish_Mexico",
        ["spa-NI"] = "Spanish_Nicaragua",
        ["spa-PA"] = "Spanish_Panama",
        ["spa-PY"] = "Spanish_Paraguay",
        ["spa-PE"] = "Spanish_Peru",
        ["spa-PR"] = "Spanish_Puerto_Rico",
        ["spa-ES"] = "Spanish_Spain",
        ["spa-US"] = "Spanish_United_States",
        ["spa-UY"] = "Spanish_Uruguay",
        ["spa-VE"] = "Spanish_Venezuela",
        ["pga"] = "Sudanese_Creole_Arabic",
        ["sun"] = "Sundanese",
        ["swa"] = "Swahili",
        ["swe"] = "Swedish",
        ["swe-FI"] = "Swedish_Finland",
        ["swe-SE"] = "Swedish_Sweden",
        ["tgl"] = "Tagalog",
        ["tgk"] = "Tajiki_Cyrillic",
        ["tzm"] = "Tamazight",
        ["tam"] = "Tamil",
    ...
    [Action("Update glossary(test)", Description = "Update an existing termbase using previously imported CSV")]
    public async Task<ImportCsvResponse> UpdateTermbase(
    [ActionParameter] ImportCsvRequest input,
    [ActionParameter] GlossaryWrapper glossaryWrapper)
    {
        if (string.IsNullOrWhiteSpace(input.TbId))
            throw new ArgumentException("Existing termbase ID (TbId) cannot be empty.");

        if (!Guid.TryParse(input.TbId, out var tbGuid))
            throw new ArgumentException($"Invalid termbase GUID: {input.TbId}");

        if (glossaryWrapper?.Glossary == null)
            throw new ArgumentException("No CSV file was provided.");

        await using var csvStream = await _fileManagementClient.DownloadAsync(glossaryWrapper.Glossary);
        csvStream.Position = 0;



        var settings = new CSVImportIntoExistingSettings
        {
            AllowAddNewLanguages = input.AllowAddNewLanguages ?? false,
            OverwriteEntriesWithSameId = input.OverwriteEntriesWithSameId ?? false,
            Delimiter = ';'
        };


        using var fileManagerClient = new FileManagerServiceClient("FileManagerServiceEndpoint");
        var fileGuid = await fileManagerClient.BeginChunkedFileUploadAsync(glossaryWrapper.Glossary.Name, false);
        ...
        while ((bytesRead = csvStream.Read(buffer, 0, buffer.Length)) > 0)
        {
            ...
            await fileManagerClient.AddNextFileChunkAsync(fileGuid, chunk);
        }

        await fileManagerClient.EndChunkedFileUploadAsync(fileGuid);

        using var tbService = new MemoqServiceFactory<ITBService>(SoapConstants.TermBasesServiceUrl, Creds);
        var taskInfo = await tbService.Service.StartCSVImportIntoExistingTBTaskAsync(fileGuid, tbGuid, settings);
